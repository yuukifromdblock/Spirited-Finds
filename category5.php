...
// Fetch products for Category 5 (Ghibli Gems)
$category_id = 5;
...
<head>
    ...
    <title>Spirited Finds - Ghibli Gems</title>
...
<!-- banner -->
<div class="banner" data-aos="fade-up" data-aos-duration="1500" style="background-image: url('./image/blue4.gif'); background-size: cover; background-position: center;">
    <div class="content">
        <h3>Magical Ghibli Treasures</h3>
        <h2>UP TO 50% OFF</h2>
            ...
            <?php else: ?>
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/Card Holder.png" alt="">
                        <div class="card-body">
                            <h4>Card Holder</h4>
                            <div class="star">
                            ...
                            <p>Simple and stylish card holder.</p>
                            <h6>₱150 <strike>₱300</strike><span><button>Add Cart</button></span></h6>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Cozy totoro carpet for your space.</p>
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/Cookie Jar.png" alt="">
                        <div class="card-body">
                            <h4>Cookie Jar</h4>
                            <div class="star">
                                <i class="bx bxs-star checked"></i>
                            ...
                            <p>Adorable cookie jar for storage.</p>
                            <h6>₱300 <strike>₱600</strike><span><button>Add Cart</button></span></h6>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/Ghibli Studio Tote Bag.png" alt="">
                        <div class="card-body">
                            <h4>Ghibli Tote</h4>
                            <div class="star">
                                <i class="bx bxs-star checked"></i>
                            ...
                            <h6>₱350 <strike>₱700</strike><span><button>Add Cart</button></span></h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="margin-top:50px;" data-aos="fade-up" data-aos-duration="1500">
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/Goosemans Totoro Lamp.png" alt="">
                        <div class="card-body">
                            <h4>Totoro Lamp</h4>
                            <div class="star">
                                <i class="bx bxs-star checked"></i>
                            ...
                            <p>Cute Totoro-themed lamp by Goosemans.</p>
                            <h6>₱750 <strike>₱1,500</strike><span><button>Add Cart</button></span></h6>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Ceramic mug with Ghibli design.</p>
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/Purple Bottle Water.png" alt="">
                        <div class="card-body">
                            <h4>Purple Bottle</h4>
                            <div class="star">
                                <i class="bx bxs-star checked"></i>
                            ...
                            <p>Stylish kiki's purple water bottle.</p>
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/Totoro Blanket.png" alt="">
                        <div class="card-body">
                            <h4>Totoro Blanket</h4>
                            <div class="star">
                                <i class="bx bxs-star checked"></i>
                                <i class="bx bxs-star checked"></i>
                                <i class="bx bxs-star checked"></i>
                            ...
                            <p>Warm and comfy Totoro blanket.</p>
                            <h6>₱500 <strike>₱1,000</strike><span><button>Add Cart</button></span></h6>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
