...
// Fetch products for Category 2 (Spirit Threads)
$category_id = 2;
...
<head>
    ...
    <title>Spirited Finds - Spirit Threads</title>
...
<!-- banner -->
<div class="banner" data-aos="fade-up" data-aos-duration="1500" style="background-image: url('./image/blue3.gif'); background-size: cover; background-position: center;">
    <div class="content">
        <h3>Stylish Ghibli Wear</h3>
        <h2>ENJOY UP TO 50% OFF YOUR FAVORITES!</h2>
...
<!-- product cards -->
<section id="product-cards2" data-aos="fade-up" data-aos-duration="1500">
    <div class="container">
            ...
            <?php else: ?>
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/Soot Sprites Cardigan.png" alt="">
                        <div class="card-body">
                            <h4>Sprite Cardigan</h4>
                            <div class="star">
                            ...
                            <p>Cozy cardigan with playful soot sprites.</p>
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/Calcifer T-Shirt.png" alt="">
                        <div class="card-body">
                            <h4>Calcifer Tee</h4>
                            <div class="star">
                                <i class="bx bxs-star checked"></i>
                            ...
                            <p>Stylish tee featuring fiery Calcifer.</p>
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/HMC Scenic.png" alt="">
                        <div class="card-body">
                            <h4>Howl's Scenic</h4>
                            <div class="star">
                                <i class="bx bxs-star checked"></i>
                            ...
                            <p>Stunning print inspired by Howl's Moving Castle.</p>
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/Princess Mononoke Scenic T-Shirt.png" alt="">
                        <div class="card-body">
                            <h4>Mononoke Scenic</h4>
                            <div class="star">
                                <i class="bx bxs-star checked"></i>
                                <i class="bx bxs-star checked"></i>
                                <i class="bx bxs-star checked"></i>
                            ...
                            <p>Breathtaking artwork from Princess Mononoke.</p>
                            <h6>₱500 <strike>₱1,000</strike><span><button>Add Cart</button></span></h6>
                        </div>
                    </div>
                </div>
