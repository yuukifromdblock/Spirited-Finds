...
// Fetch products for Category 3 (Cuddly Companions)
$category_id = 3;
...
<head>
    ...
    <title>Spirited Finds - Cuddly Companions</title>
...
<!-- banner -->
<div class="banner" data-aos="fade-up" data-aos-duration="1500" style="background-image: url('./image/blue2.gif'); background-size: cover; background-position: center;">
    <div class="content">
        <h3>Cuddly Ghibli Plushies</h3>
        <h2>ENJOY UP TO 50% OFF YOUR FAVORITE TOYS!</h2>
...
<!-- product cards -->
<section id="product-cards3" data-aos="fade-up" data-aos-duration="1500">
    <div class="container">
        <h1>CUDDLY COMPANIONS</h1>
            ...
            <?php else: ?>
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/Warawara Plushie.png" alt="">
                        <div class="card-body">
                            <h4>Warawara Plushie</h4>
                            <div class="star">
                            ...
                            <p>Soft and cuddly Warawara plush toy.</p>
                            <h6>₱450 <strike>₱900</strike><span><button>Add Cart</button></span></h6>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/Heron Plushie.png" alt="">
                        <div class="card-body">
                            <h4>Heron Plushie</h4>
                            <div class="star">
                                <i class="bx bxs-star checked"></i>
                            ...
                            <p>Adorable heron plush, perfect for fans.</p>
                            <h6>₱400 <strike>₱800</strike><span><button>Add Cart</button></span></h6>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/Soot Sprite.png" alt="">
                        <div class="card-body">
                            <h4>Soot Sprite</h4>
                            <div class="star">
                                <i class="bx bxs-star checked"></i>
                            ...
                            <p>Cute Soot Sprite plushie for cozy cuddles.</p>
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        ...
                        <img src="./image/Calcifer Plushie.png" alt="">
                        <div class="card-body">
                            <h4>Calcifer Plushie</h4>
                            <div class="star">
                                <i class="bx bxs-star checked"></i>
                                <i class="bx bxs-star checked"></i>
                                <i class="bx bxs-star checked"></i>
                            ...
                            <p>Fiery Calcifer plushie to brighten your day.</p>
                            <h6>₱1,000 <strike>₱500</strike><span><button>Add Cart</button></span></h6>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
